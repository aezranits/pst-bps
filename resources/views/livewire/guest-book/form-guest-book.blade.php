<div x-data="{ pekerjaan: '{{ $pekerjaan }}', jenisKelamin: '{{ $jenis_kelamin }}', tujuanLainnya: false }"
  ...
  <div
   ...
   <form wire:submit.prevent="submit">
    ...
    <div class="sm:pb-6 pb-3">
     <livewire:components.text-input colorText="text-grey" label="Nama Lengkap" name="nama_lengkap" placeholder="Ade Setiawan"
      wire:model="nama_lengkap" />
    </div>

    <!-- Jenis Kelamin -->
    <livewire:components.radio-button-input  colorText="text-grey" name="jenis_kelamin" label="Jenis Kelamin" :options="['Laki-Laki' => 'Laki-Laki', 'Perempuan' => 'Perempuan']" />

    <!-- Umur -->
    <div class="sm:py-6 py-3">
     <livewire:components.text-input colorText="text-grey" type="number" label="Usia" name="usia" wire:model="usia" placeholder="25" />
    </div>

    <!-- Pekerjaan -->
    <livewire:components.radio-button-input  colorText="text-grey" name="pekerjaan" label="Pekerjaan" :options="[
        'mahasiswa' => 'Mahasiswa',
    ...
    <div x-show="pekerjaan === 'mahasiswa'">
     <div>
      <div class="sm:py-6 py-3">
       ...
       <livewire:components.text-input colorText="text-grey" label="Jurusan" name="jurusan" placeholder="Statistika" wire:model="jurusan" />
      </div>
      <div class="sm:py-6 py-3">
    ...
    <div x-show="pekerjaan === 'dinas/instansi/opd'">
     <div class="sm:py-6 py-3">
      ...
      <livewire:components.text-input colorText="text-grey" label="Asal Instansi" name="asal" placeholder="Diskominfo Kota Bukittinggi" wire:model="asal" />
     </div>
    </div>
    ...
    <div x-show="pekerjaan === 'peneliti'">
     <div class="sm:py-6 py-3">
      ...
      <livewire:components.text-input colorText="text-grey" label="Asal Universitas / Lembaga Penelitian" name="asal_universitas_lembaga" wire:model="asal_universitas_lembaga"/>
     </div>
    </div>
    ...
    {{-- No HP --}}
    <div class="sm:py-6 py-3">
     <livewire:components.text-input colorText="text-grey" type="tel" label="No HP" name="no_hp" wire:model="no_hp"
    ...
    <div class="sm:py-6 py-3">
     <livewire:components.select-option  colorText="text-grey" name="kota_id" label="Kota" :options="$this->regencies" wire:model.live="kota_id"
      :key="$this->regencies->pluck('id')->join('-')">
    </div>

    <div class="sm:py-6 py-3">
     <livewire:components.text-input colorText="text-grey" type="textarea" rows="4" name="alamat" label="Alamat" wire:model="alamat"
    ...
    <div class="sm:pb-6 pb-3">
     <div x-show="tujuanLainnya">
      <livewire:components.text-input colorText="text-grey" type="textarea" rows="4" name="tujuan_kunjungan_lainnya"
       wire:model="tujuan_kunjungan_lainnya" placeholder="Sebutkan tujuan lainnya" />
     </div>
    </div>
