				...
				<div
					...
					<div class="bg-lightBlue">
						<div class="m-10 rounded-full md:m-5 bg-grey">
							<img class="p-6 md:p-10" src="{{ asset('img/perpustakaan-logo.svg') }}" alt="Logo Penjualan">
						</div>
					</div>
					<div>
						<div class="p-4">
							<p class="text-xl md:text-2xl font-bold  text-darkBlue">Perpustakaan</p>
							<p class="text-lightYellow ">Layanan Umum </p>
							<p >Publikasi statistik terbitan BPS dari berbagai kategori: kependudukan, sosial, sosial ekonomi,
								pertanian, dan
								lain lain.</p>
						</div>
					</div>
