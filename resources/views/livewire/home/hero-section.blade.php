<div class="relative bg-lightBlue  h-screen flex items-center">
	...
	<div class="relative flex flex-col items-center max-w-3xl px-6 py-32 mx-auto text-center sm:py-64 lg:px-0">
        ...
        <div class="mt-4">
            <p class="text-white lg:text-lg ">Selamat datang di Pelayanan Statistik Terpadu BPS Bukittinggi. Di website ini
                Anda dapat menemukan berbagai layanan yang kami sediakan dan informasi kontak yang dapat dihubungi.</p>
        </div>
        <div class="mt-6">
