      ...
      <div class="py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200">
        <div class="min-w-0 flex-1">
          ...
          <div class="flex items-center">
            <img src="{{ asset('img/user.svg') }}" alt="" class="hidden h-16 w-16 rounded-full sm:block">
            <div>
              <div class="flex items-center">
                ...
                <h1 class="ml-3 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:leading-9">Selamat datang, {{ $name }}</h1>
              </div>
        ...
        <div class="mt-6 flex space-x-3 md:ml-4 md:mt-0">
            <p class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Total Guest Books (Done): {{ $doneGuestBooks }}</p>
            <p class="inline-flex items-center rounded-md bg-cyan-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-cyan-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600">Feedback Rating: {{ $feedbackRating }} / 5</p>
        </div>
        @endif
      </div>
    </div>
